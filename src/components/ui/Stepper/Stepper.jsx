...
export const Stepper = ({
  ...
  // Подключаем хранилище для обновления данных корзины
  const { incrementQuantity, decrementQuantity } = useProducts();
    ...
    <div className="py-2 px-3 inline-block bg-white border border-gray-200 rounded dark:bg-neutral-900 dark:border-neutral-700">
      <div className="flex items-center gap-x-1.5">
        <button
          ...
          type="button"
          className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
          tabIndex="-1"
          aria-label="Decrease"
        >
          <svg
